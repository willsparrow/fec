...
from .main import *
from apps.ec.views import get_prod_list, get_prod_list_by_category, get_prod_detail, add_to_cart, get_cart_detail, checkout, checkout_confirm, get_order_list, get_order_detail
